...
IUSE="alsa aalib altivec curl dbus debug doc exif gnome hal jpeg lcms mmx mng pdf png python smp sse svg tiff webkit wmf gimp-painter"
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	use gimp-painter && epatch "${FILESDIR}/gimp-painter--20090715.diff"
}
